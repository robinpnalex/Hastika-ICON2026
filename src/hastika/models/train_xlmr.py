...
from hastika.common.paths import PROJECT_ROOT, RUNS_DIR
...
def main():
    ...
    train = pd.read_csv(ROOT / "data" / "raw" / "binary_train.csv")
    test = pd.read_csv(ROOT / "data" / "raw" / "binary_validation_inputs.csv")
