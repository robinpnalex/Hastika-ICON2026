...
|---|---|---|---|
| `kaggle_grid.ipynb` | **Current.** Factorial over both data-processing levers, ten cells on the real holdout, then a five-seed full fit of the winner. | ~8.5 h | **yes**, every cell |
