...
def main():
    ...
    ap.add_argument("--out", default="work/runs/muril-extended")
    ...
    print(f"\nwrote {out}")
    print(f"next:  python work/tapt.py --model {a.out} --out work/runs/tapt-extended")
    print(f"then:  python work/muril_b.py --model work/runs/tapt-extended --tag b_ext")
